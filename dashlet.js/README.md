## Overview
This module is a reference client implementation for short video streaming that is inherited from [DASH.js](https://github.com/Dash-Industry-Forum/dash.js). the playback of MPEG DASH via JavaScript and [compliant browsers](http://caniuse.com/#feat=mediasource).

## To use the module

1. Start the ABR server module first. Make sure 8333 port is not occupied before it is started.
2. include the dash.all.min.js or dash.all.debug.js under /dist/ to your web based video player.
3. Start to play short video
