...
setTimeout(function() {
    Java.perform(function() {
        ...
        try {
            var cleaner = Java.use('okhttp3.internal.tls.BasicCertificateChainCleaner');
            console.log("[+] OkHTTP3 cleaner Found");
            cleaner.verifySignature.overload('java.security.cert.X509Certificate', 'java.security.cert.X509Certificate').implementation = function() {
                console.log("[+] OkHTTP 3.x check() called. Not throwing an exception.");
                return True;
            };
        } catch (err) {
            // If we dont have a ClassNotFoundException exception, raise the
            // problem encountered.
            console.log("[-] OkHTTP3 cleaner Not Found")
            console.log(err)
        }


     //    try {
     //    	var httpsconnection = Java.use('com.bytedance.apm.agent.instrumentation.HttpsURLConnectionExtension');
     //    	console.log("[+] httpsconnection Found");

     //    	httpsconnection.getServerCertificates.overload().implementation = function() {
     // //    		    try {
     ...
     //    	}
     //    } catch (err) {
     //    	console.log("[+] httpsconnection not Found");
     //    	console.log(err);
     //    }
