...
if __name__ == "__main__":
    try:
        ...
        parser.add_argument('--probabilitytraces', default='/home/acer/Documents/ttstream/testing/swipetrace/full_accuracy/140.180.240.50-0.txt', help='The path to save processed data')
