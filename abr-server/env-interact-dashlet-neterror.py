...
class env:
    ...
    def __init__(self, seqname, traceanme, networktracename, neterror):
    ...
    def estimate_throughput(self, current_ts):
        ...
        return mean_tp * (1 + self.neterror)
...
def main(args):
    ...
    e = env(args.playtrace, args.swipetrace, args.networktrace, float(args.neterror))
    e.run()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--neterror', default=0, help='The network trace')
