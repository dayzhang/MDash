...
if __name__ == '__main__':
    ...
    parser.add_argument('--playtrace', default="/home/acer/Documents/reverse-tiktok/data/trace-4.5-swipe-5/trace-4.5-swipe-5-play.csv", help='Play sequence')
    parser.add_argument('--swipetrace', default="/home/acer/Documents/reverse-tiktok/traces/swipe/swipe-5.txt", help='Viewing trace')
    parser.add_argument('--networktrace', default="/home/acer/Documents/reverse-tiktok/traces/network/trace-4.5.down", help='The network trace')
